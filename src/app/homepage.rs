    ...
    view! {
        ...
        <section class="flex grow justify-start">
            <div class="w-full max-w-4xl">
                ...
                <p class="text-base mb-2">
                    "I've been working in software development since 2016.  I've been all the way up the career ladder from Junior Software Engineer to Senior Software Engineer to Engineering Manager to Director of Engineering and now Principal Architect.  I take a lot of pride in my work and always strive for excellence.  I have respect for my coworkers - my goal is always to lift up those around me.  I have respect for my users - I bring a customer-centric mindset into my work and go beyond specs to build the best experience for the user."
                </p>
                <p class="text-base mb-2">
                    "For the past 7 years, I've been working at Multi Media LLC.  We run one of the largest sites on the internet, with over 2 billion monthly sessions and petabtye scale data.  Our platform is a highly interactive live streaming web app.  I've worked all across the stack as an engineer - frontend, backend, microservice, and tooling.  In the director role, I lead the team through consistent user and revenue growth, maintained business alignment, and implemented meaningful processs improvements.  I'm very proud of what I've accomplished so far at Multi Media LLC and can't wait to see what the future holds."
                </p>
                <p class="text-base mb-2">
        ...
        <section class="flex grow justify-end">
            <div class="w-full max-w-4xl">
                ...
                <p class="text-base mb-2">
                    "I'm a husband and a father of an amazing daughter.  We also have 2 cats and dog who we spoil.  My wife and I love to try new foods - we're always looking for interesting places to eat when we travel.  I'm a massive nerd - some of my favorite activies with friends include Gloomhaven/Frosthaven, Magic: The Gathering, or playing DotA 2 over Discord.  But I also enjoy outdoor activies - board sports, cycling, and rock climbing."
                </p>
                <p class="text-base mb-2">
                ...
                <p class="text-base mb-2">
                    "Some random facts about me:  In college I was sponsored for yoyoing and competed in the World Yoyo Contest.   In high school, I trained with the USA Olympic Bobsledding team but decided not to pursue the sport because I would have had to move across the country (Lake Placid, NY).  In undergrad university, I was Pre-Med and only decided to switch to switch to computer science after graduation while studying for the MCAT."
                </p>
            </div>
        </section>
        <section class="flex justify-center items-center mt-4">
            <div class="w-full max-w-2xl text-center">
                ...
                <p>"Feel free to reach out to me for inquiries, mentorship, or opportunities."</p>
